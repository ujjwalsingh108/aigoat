...
export default function NiftyFOPage() {
  ...
  const loadSignals = useCallback(async () => {
    try {
      ...
      if (error) {
        console.error("Error loading NIFTY F&O signals:", error);
      } else {
        setSignals(data || []);
        setLastUpdate(new Date());
      }
    } catch (err) {
      console.error("Exception loading NIFTY F&O signals:", err);
    } finally {
      setIsLoading(false);
    }
  }, [supabase]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              NIFTY Futures & Options intraday signals
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  NIFTY trading above 20 EMA (5-min timeframe)
                  <br />
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  NIFTY trading below 20 EMA (5-min timeframe)
                  <br />
                  Target 1: 50 points | Target 2: 75 points
                  <br />
      ...
      {!isLoading && signals.length === 0 && (
        <Card className="py-12">
          <CardContent className="text-center">
            ...
            <p className="text-lg font-semibold">No NIFTY F&O Signals Found</p>
